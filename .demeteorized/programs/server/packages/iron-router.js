...
IronRouter.prototype = {                                                                                          // 23
  ...
  configure: function (options) {                                                                                 // 35
    ...
    this.options = this.options || {};                                                                            // 38
                                                                                                                  // 39
    // e.g. before: fn OR before: [fn1, fn2]                                                                      // 40
    _.each(IronRouter.HOOK_TYPES, function(type) {                                                                // 41
      if (self.options[type]) {                                                                                   // 42
        _.each(Utils.toArray(self.options[type]), function(hook) {                                                // 43
          self._globalHooks[type].push({hook: hook});                                                             // 44
        });                                                                                                       // 45
                                                                                                                  // 46
        delete self.options[type];                                                                                // 47
      }                                                                                                           // 48
    });                                                                                                           // 49
                                                                                                                  // 50
    _.extend(this.options, options);                                                                              // 51
    return this;                                                                                                  // 52
  },                                                                                                              // 53
                                                                                                                  // 54
                                                                                                                  // 55
